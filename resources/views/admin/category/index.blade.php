...
@section('content')
    <div class="col-md-12">
      ...
      <a class="btn @php if(request()->input('status') == 'trash') { echo 'btn-primary'; } else{ echo 'btn-secondary'; } @endphp mb-3 float-right" href="{{ request()->fullUrlWithQuery(['status' => 'trash']) }}" role="button">Thùng rác ({{ $countTrash }})</a>
    ...
    @if ($categories->count() < 1)
        <div class="alert alert-danger" role="alert">
          Chưa có danh mục nào đang kích hoạt
        </div>
    @else
