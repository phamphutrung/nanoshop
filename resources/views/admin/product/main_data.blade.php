    ...
    @foreach ($products as $key => $product)
        <tr id="product-{{ $product->id }}">
            ...
            <td data-toggle="tooltip" data-placement="top" title="Xem chi tiết"
                class="text-center text-bold productItem" data-id="{{ $product->id }}" style="cursor: pointer;"
            ...
            <td class="text-center">
                <a data-toggle="tooltip" data-placement="top" title="Chỉnh sửa" class="btn btn-primary"
