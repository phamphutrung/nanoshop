...
@section('content')
    <div class="card">
                ...
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <div class="col-md-12 mb-4">
                            ...
                            <input value="{{ old('selling_price') }}" id="selling_price" class="form-control" type="text"
                                name="selling_price" placeholder="Nhập giá bán hiện tại">
                            @error('selling_price')
                                <small id="emailHelp" class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-12 d-flex align-items-center">
                            <div class="col-md-6 mb-4 ml-3">
                                <input class="form-check-input" type="checkbox" value="1"
                                    {{ old('status') ? 'checked' : '' }} id="status" name="status">
                            ...
                            <div class="col-md-6 mb-4 f-right">
                                <input class="form-check-input" type="checkbox" value="1"
                                    {{ old('trending') ? 'checked' : '' }} id="popular" name="trending">
        ...
        <div class="card-footer">
            <div>
                <button class="btn btn-success" type="submit"><i class="fa-regular fa-floppy-disk mr-1"></i>Tạo
                    mới</button>
                <a href="{{ route('admin-product') }}" class="btn btn-secondary ml-2"><i
                        class="fa-solid fa-ban mr-1"></i>Hủy</a>
                </form>
            </div>
        </div>
    </div>
